...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>发文稿纸（领导填写）</title>
		<meta http-equiv="pragma" content="no-cache">
		<meta http-equiv="cache-control" content="no-cache">
		<meta http-equiv="expires" content="0">
		<meta http-equiv="description" content="发文稿纸（领导填写）">
...
//签发、附件
	...
	document.getElementById("signSelect").style.display="";
...
function changeDiv(showDiv,hideDiv){
	...
	<body onload="init()">
		<html:form action="/xdocSendLeader" enctype="multipart/form-data" method="post">
        ...
        <tr>
          <td width="288" height="40" align="left" valign="middle" background="images/8-1.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="84%" class="table2_topic">发文稿纸（领导填写）</td>
            </tr>
          </table></td>
