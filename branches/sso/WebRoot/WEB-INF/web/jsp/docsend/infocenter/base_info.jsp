...
function leaderPostil(){
	...
	var rs = prompt("请输入批示：","");
	if(rs){
		otext.value=rs+"---${SYSTEM_USER_SESSION.name}领导  "+getNow();
	}
}
function leaderSay(){
	...
	otext.value+="---${SYSTEM_USER_SESSION.name}领导  "+getNow();
}
function getNow(){
	today = new Date();
...
//-->
			...
			<logic:equal name="xdocSendForm" property="secret1" value="依申请公开">
			<html:option value="内部信息"></html:option>
			<html:option value="《规定》外其他信息"></html:option>
			</logic:equal>
			<logic:equal name="xdocSendForm" property="secret1" value="不予公开">
			...
			<table width="99%" border="0" cellpadding="0" cellspacing="1" class="tabin1_in">
				<thead>
					...
					<tr>
			    		<td nowrap width="60" height="24" align="center">行文类别</td>
			    		<td colspan="7">
				    		<html:select property="sendFileType" style="display:none">
							<html:option value="上行文"></html:option>
							<html:option value="平行文"></html:option>
							<html:option value="下行文"></html:option>
							</html:select>
			    	...
			    	<tr>
			    		...
			    		<tr>
			    		<td nowrap>
			    		<input type="radio" name="signrRadio" value="1" onclick="leaderSay()"/>已阅&nbsp;
			    		<input type="radio" name="signrRadio" value="2" onclick="leaderSay()"/>同意&nbsp;
			    		<a href="#" onclick="leaderPostil();return false;">批示</a>&nbsp;
			    		<input type="button" value="驳回" onclick="clearSay('sign');returnback()" class="button0">
			    		</td></tr>
			    		</table>
		    		</td>
			    	</tr>
			    	<tr>
			    		<td align="center" height="25">拟稿人</td>
			    	...
			    	<tr>
			    		<td align="center" height="25">文号</td>
			    	...
			    	<tr>
			    		...
			    		<td align="center" nowrap>成文日期</td>
