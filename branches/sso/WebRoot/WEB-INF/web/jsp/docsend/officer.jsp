...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>发文稿纸（局办公室负责人填写）</title>
		<meta http-equiv="pragma" content="no-cache">
		<meta http-equiv="cache-control" content="no-cache">
		<meta http-equiv="expires" content="0">
		<meta http-equiv="description" content="发文稿纸（局办公室负责人填写）">
...
function init(){
//办公室核稿人、办公室负责人、附件
	var needInputs = new Array("officeDraftUser","officeChargeUser");
	...
	document.getElementById("officeDraftUser").value=curUserName;
	document.getElementById("officeChargeUser").value=curUserName;
...
function checkForm(form){
	var rs = true;
	if(form.officeDraftUser.value==""){
		alert("请输入办公室核稿人");
		rs = false;
	}
	if(form.officeChargeUser.value==""){
		alert("请输入办公室负责人");
		rs = false;
	}
...
function changeDiv(showDiv,hideDiv){
	...
	<body onload="init()">
		<html:form action="/docSendOfficer" enctype="multipart/form-data" method="post">
        ...
        <tr>
          <td width="288" height="40" align="left" valign="middle" background="images/8-1.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="84%" class="table2_topic">发文稿纸（局办公室负责人填写）</td>
            </tr>
          </table></td>
