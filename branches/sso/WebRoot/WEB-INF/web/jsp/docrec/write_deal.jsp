...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>上海市水务信息中心公文处理单（办理情况填写）</title>
		<meta http-equiv="pragma" content="no-cache">
		<meta http-equiv="cache-control" content="no-cache">
		<meta http-equiv="expires" content="0">
		<meta http-equiv="description" content="上海市水务信息中心公文处理单（办理情况填写）">
...
function init(){
//办理情况、附件
	var needInputs = new Array("dealState");
...
function changeDiv(showDiv,hideDiv){
	...
	<body onload="init()">
		<html:form action="/docrecwritedeal" enctype="multipart/form-data" method="post">
        ...
        <tr>
          <td width="288" height="40" align="left" valign="middle" background="images/8-1.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="84%" class="table2_topic">上海市水务信息中心公文处理单（办理情况填写）</td>
            </tr>
          </table></td>
