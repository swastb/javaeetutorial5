...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>上海市水务信息中心公文<>处理单（拟办人处理）</title>
		<meta http-equiv="pragma" content="no-cache">
		<meta http-equiv="cache-control" content="no-cache">
		<meta http-equiv="expires" content="0">
		<meta http-equiv="description" content="上海市水务信息中心公文处理单（拟办人处理）">
...
function init(){
//拟办意见、拟办人、拟办结日期、附件
	var needInputs = new Array("draftOpinion","auditUser","overDate");
	...
	document.getElementById("draftSelect").style.display="block";
}
//-->
</script>
<script type="text/javascript">
...
function checkForm(form){
	var rs = true;
	if(!checkEmpty(form.overDate)){
		rs = false;
	}
	if(!isDate(form.overDate)){
		alert("日期格式不对！");
		rs = false;
	}
	...
	var radios = docRecBookForm.draftRadio;
	if(radios[0].checked){
		leader = document.getElementById("leader1");
		if(leader.value==""){
			alert("请选择领导");
			return false;
		}
	}else if(radios[1].checked){
		leader = document.getElementById("leader2")
		if(leader.value==""){
			alert("请选择领导");
			return false;
		}
		dept = document.getElementById("mainDept2")
		if(dept.value==""){
			alert("请选择主办部门");
			return false;
		}
	}else if(radios[2].checked){
		leader = document.getElementById("leader3")
		if(leader.value==""){
			alert("请选择领导");
			return false;
		}
		dept = document.getElementById("mainDept3")
		if(dept.value==""){
			alert("请选择主办部门");
			return false;
		}
	}else if(radios[3].checked){
		person = document.getElementById("person4");
		if(person.value==""){
			alert("请选择传阅人员！");
			return false;
		}
...
function changeDiv(showDiv,hideDiv){
	...
	<body onload="init()">
		<html:form action="/docRecDispose" enctype="multipart/form-data" method="post">
        ...
        <tr>
          <td width="288" height="40" align="left" valign="middle" background="images/8-1.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="84%" class="table2_topic">上海市水务信息中心公文<br>处理单（拟办人处理）</td>
            </tr>
          </table></td>
