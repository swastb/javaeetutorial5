...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>上海市水务信息中心公文处理单（领导处理）</title>
		<meta http-equiv="pragma" content="no-cache">
		<meta http-equiv="cache-control" content="no-cache">
		<meta http-equiv="expires" content="0">
		<meta http-equiv="description" content="上海市水务信息中心公文处理单（领导处理）">
...
function init(){
//领导批示、附件
	var needInputs = new Array("leaderAudit");
	...
	var draftRadio="${draftRadio}";
	if(draftRadio=="1"){
		document.getElementById("leaderRidioLabel").style.display="none";
		document.getElementById("leaderChooseDept1").style.display="none";
		document.getElementById("leaderChooseDept2").style.display="none";
	}
}
//-->
</script>
...
function checkForm(form){
	...
	var radios = docRecBookForm.leaderRadio;
	if(radios[1].checked){
		dept = document.getElementById("mainDept4")
		if(dept.value==""){
			alert("请选择主办部门");
			return false;
		}
...
function changeDiv(showDiv,hideDiv){
	...
	<body onload="init()">
		<html:form action="/docRecLeader" enctype="multipart/form-data" method="post">
