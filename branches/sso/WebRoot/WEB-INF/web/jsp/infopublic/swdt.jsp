...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	List resultList = (List) request.getAttribute("resultList2");
%>
	...
	<body topmargin="0">
		<table width="305" height="1" align="center" border="0"
			...
			<tr>
				...
				<td width="72" height="18" align="right" class="zw-time">[<%=item.getRecordTime() == null ? "" : item.getRecordTime().toString().substring(5, 10)%>]
				</td>
			</tr>
			<tr>
			...
			<table width="305" height="5" valign="top" align="center" border="0"
				...
				<tr>
					...
					<td height="20" vaign="top" align="center">
						&nbsp;&nbsp;&nbsp;
						<a
							href="<%=path%>/infopubContentaction.do?method=wzdt_more&name=Ë®Îñ¶¯Ì¬&code=swdt"
