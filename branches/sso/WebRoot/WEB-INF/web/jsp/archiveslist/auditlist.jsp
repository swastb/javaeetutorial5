        ...
        <tr>
          <td width="288" height="40" align="left" valign="middle" background="images/8-1.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="84%" class="table2_topic">档案审批列表</td>
            </tr>
          </table></td>
                ...
                <tr>
                  <td align="center" valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="16%" class="tabin_atabno"><a href="<%=path%>/archivesListAction.do?method=noPigeonholeList"><span class="bg-zw">档案列表</span></a></td>
                      ...
                      <td width="16%" class="tabin_atab">档案审批列表</td>
                      <td width="50%">&nbsp;</td>
                    </tr>
                  </table>
									...
									<tr height="20" align="center" class="bg-zw">
										...
										<td width="20%">
											...
											<input type="button" class="button1"
												onclick="if(confirm('是否确认批准')){auditApply('<%=item[3]%>','1')}"
												value="批准" />
											<input type="button" class="button1"
												onclick="if(confirm('是否确认驳回')){auditApply('<%=item[3]%>','0')}"
												value="驳回" />
											<%
											} else {
											%>
