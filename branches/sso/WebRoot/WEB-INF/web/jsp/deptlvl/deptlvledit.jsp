...
<html>
	<head>
		...
		<script type='text/javascript'
			src='<%=strpath%>/dwr/interface/deptlvl.js'></script>
		<script type="text/javascript" src="<%=path%>/js/common.js"></script>

	</head>

	<body>
		<html:form action="/deptlvlaction.do">
        ...
        <tr>
          <td width="288" height="40" align="left" valign="middle" background="images/8-1.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="84%" class="table2_topic">部门级别</td>
            </tr>
          </table></td>
					...
					<tr>
																	...
																	<td colspan="2">
																		<html:text property="ename" maxlength="32"
																			...
																			onblur="chk(),deptlvlEnameCheck();"></html:text>
																		<font color="red">*</font>
																		<font color="red"> <span id="fename"></span> <span
																			id="deptlvlEnameCheck"></span> </font>
																	</td>
																</tr>
																<tr>
																	<td nowrap width="110" height="25" align="left">
																	...
																	<td colspan="2">
																		<html:text property="code" maxlength="32"
																			styleClass="shuruk2" onkeydown="notNull();"
																			onblur="chk(),deptlvlCodeCheck();"></html:text>
																		<font color="red">*</font>
																		<font color="red"> <span id="fcode"></span> <span
																			id="deptlvlCodeCheck"></span> </font>
																	</td>
																</tr>
																<tr>
																	<td nowrap width="110" height="25" align="left">
...
<script type="text/javascript">
		   ...
		   var rem = document.getElementById("rem").value;
            ...
            if(this.deptlvlEnameflag=="false"){alert("不能重复"); return false;}
            
            			deptlvlCodeCheck();
           
            if(this.deptlvlCodeflag=="false"){alert("不能重复"); return false;}
			if(document.all.id.value==''){document.all.method.value='add'}
				...
				window.location.replace(pah+"/deptlvlaction.do?method=list");
