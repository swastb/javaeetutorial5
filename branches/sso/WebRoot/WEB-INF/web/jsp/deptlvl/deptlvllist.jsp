...
<jsp:directive.page import="com.baosight.mode.TbDeptlvl"/>

<%
String path = request.getContextPath();
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
List alldeptlvl = (List)request.getAttribute("alldeptlvl");
%>
	...
	<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
       ...
       <table width="100%" align="center" border="1" cellpadding="0" cellspacing="1" bgcolor="#0e88b9">			
              ...
              <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="table2bgin">
                ...
                <tr>
                  <td align="center" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0"> 
                      ...
                      <td width="14%" class="tabin_atab">部门级别</td>
                   ...
                   <tr>
                   <td height="25" colspan="6" valign="bottom" bgcolor="#f7f7f7" align="right">&nbsp;
    	...
    	<tr align="center" class="bg-zwbt">
    		...
    		<th width="25%" align="center" style="word-break: break-all; word-wrap:break-word;">部门级别缩写名称</th>
    		<th width="25%" align="center" style="word-break: break-all; word-wrap:break-word;">部门级别代码</th>
    		<th width="35%" align="center" style="word-break: break-all; word-wrap:break-word;">部门级别中文说明</th>
    		<th width="10%" align="center"  colspan="2">操作</th>
    	</tr>
    	<%for (int i = 0; i < alldeptlvl.size(); i++) {
    		TbDeptlvl item = (TbDeptlvl)alldeptlvl.get(i);
    		%>
    		<tr align="center" class="bg-zw">
    			...
    			<td width="5%" align="center"><a title="修改" href="<%=path %>/deptlvlaction.do?method=modify&id=<%=item.getId() %>"><img src="<%=path %>/images/icon9.gif" width="15" height="15" border="0"></a></td>
    			<td width="5%" align="center"><a title="删除" href="<%=path %>/deptlvlaction.do?method=delete&id=<%=item.getId() %>" onclick="return confirm('是否确认删除')"><img src="<%=path %>/images/icon6.gif" width="15" height="15" border="0"></a></td>
    		</tr>
    		<%
    	} %>
  </table>
...
<script type="text/javascript">
			...
			function add()
			{
             ...
             window.location.replace("<%=path %>/deptlvlaction.do?method=add&action=add");
