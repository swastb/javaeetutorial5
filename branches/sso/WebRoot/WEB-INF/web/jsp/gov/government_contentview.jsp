...
<html>
	...
	<jsp:include flush="true" page="../infopublic/top.jsp" />
		
		<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
		<form action="govern.do" method="post">
  <tr>
        ...
        <td valign="top" bgcolor="#f1f8fc"><table width="100%" border="0" cellspacing="1" cellpadding="0">
           ...
           <table width="82%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="90%" align="center" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="35" align="center"><input class="bg-zw" name="Submit" type="button" onClick="window.close()" value="¹Ø±Õ´°¿Ú"></td>
				</tr>
			</table>
		</form>
	</body>
