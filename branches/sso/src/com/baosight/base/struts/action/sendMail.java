...
public static void main(String[] args) { 
		...
		if (themail.setTo("happyyangxue56@hotmail.com") == false)
			return;

		if (themail.setFrom("happyyangxue56@163.com") == false)
			return;

//	    if (themail.addFileAffix("") == false)
//			return;

		themail.setNamePass("happyyangxue56", "831114");
