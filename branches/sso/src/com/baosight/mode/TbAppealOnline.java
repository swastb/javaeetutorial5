...
/**
 * TbAppealOnline generated by MyEclipse Persistence Tools
 */

public class TbAppealOnline implements java.io.Serializable {
	...
	/** default constructor */
	public TbAppealOnline() {
	}

	/** full constructor */
	public TbAppealOnline(String asker, String askerEmail, String askerPhone,
			String subject, String content, Date askTime, String response,
			Date responseTime, String responseor, Long status) {
		this.asker = asker;
	...
	public Set getTbPublicAffairTransacts() {
		return tbPublicAffairTransacts;
	}
