...
public class PrintAction extends Action{
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(method.equals("add")){
			...
			String needPrintURL = request.getParameter("needPrintURL");
			String isOrNotPrint = request.getParameter("isOrNotPrint");
			request.setAttribute("needPrintURL", needPrintURL+"&id="+id);
			request.setAttribute("isOrNotPrint", isOrNotPrint);
