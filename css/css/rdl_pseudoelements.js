...
with (oElementDIV) {className='cssColumnTitle';innerText='应用于：';}
...
with (oShowCode) 
{if (value!='察看代码') value='隐藏代码';else value='察看代码';}
}
