...
function dhAjaxTreeView(path) {
	...
	//定义请求地址
	this.postUrl = "/sso/shortInfo.do?method=showCommonGroupTree&cid=";
	//角色ID
	this.rid = null;
	//定义客户端指定结点事件
	...
	//alert("dbupdate");
					if (id == "" || id == "0") {
						...
						window.open("/shortInfo.do?method=showCommonGroupTree&cid=" + id, "_self");
					}
	};
	//点击节点事件
...
//alert("parseTypeXML");	
	...
	for (i = 0; i < len; i++) {
		...
		if (i == len - 1) {
			if (isNode == "true") {			
					tempStr = tempStr + "<div class=\"lastnode\" atid=\"" + id + "\" textvalue=\"" + name + "\"  parId=\"" + parId + "\" isNode=\"" + isNode + "\" ><img src=\"[dhfolder]/lplus.gif\" align=\"absmiddle\" onclick=\"[dhATV].clickNode(this.parentNode,'icon');\" /><img src=\"[dhfolder]/nc.gif\" align=\"absmiddle\" /><input type=\"checkbox\" isF=false parId=\"" + parId + "\" rname=\""+name+"\" id=\""+id+"\" isNode=\"" + isNode + "\" onclick=\"[dhATV].clickNodeCheckBox(this.parentNode,'" + name + "','" + id + "','" + isNode + "',this);\" rid='"+id+"' /><span class=\"nodetext\" onclick=\"[dhATV].clickNode(this.parentNode,'" + name + "');\" >" + name + "</span><span class=\"nodepanel\"></span></div>";
			} else {
					tempStr = tempStr + "<div class=\"lastvalue\" atid=\"" + id + "\" textvalue=\"" + name + "\"  parId=\"" + parId + "\" isNode=\"" + isNode + "\" ><img src=\"[dhfolder]/l.gif\" align=\"absmiddle\" /><img src=\"[dhfolder]/topic.gif\" align=\"absmiddle\" /><input type=\"checkbox\" parId=\"" + parId + "\" isF=false rname=\""+name+"\" id=\""+id+"\" isNode=\"" + isNode + "\" onclick=\"[dhATV].clickNodeCheckBox(this.parentNode,'" + name + "','" + id + "','" + isNode + "',this);\" rid='"+id+"' /><span class=\"nodetext\" onclick=\"[dhATV].clickNode(this.parentNode,'" + name + "');\" >" + name + "</span></div>";
			}
		} else {
			if (isNode == "true") {
					tempStr = tempStr + "<div class=\"childnode\" atid=\"" + id + "\" textvalue=\"" + name + "\"  parId=\"" + parId + "\" isNode=\"" + isNode + "\" ><img src=\"[dhfolder]/tplus.gif\" align=\"absmiddle\" onclick=\"[dhATV].clickNode(this.parentNode,'icon');\" /><img src=\"[dhfolder]/nc.gif\" align=\"absmiddle\" /><input type=\"checkbox\" parId=\"" + parId + "\" isF=false rname=\""+name+"\" id=\""+id+"\" isNode=\"" + isNode + "\" onclick=\"[dhATV].clickNodeCheckBox(this.parentNode,'" + name + "','" + id + "','" + isNode + "',this);\" rid='"+id+"' /><span class=\"nodetext\" onclick=\"[dhATV].clickNode(this.parentNode,'" + name + "');\" >" + name + "</span><span class=\"nodepanel\"></span></div>";
			} else {
					tempStr = tempStr + "<div class=\"childvalue\" atid=\"" + id + "\" textvalue=\"" + name + "\"  parId=\"" + parId + "\" isNode=\"" + isNode + "\" ><img src=\"[dhfolder]/t.gif\" align=\"absmiddle\" /><img src=\"[dhfolder]/topic.gif\" align=\"absmiddle\" /><input type=\"checkbox\" parId=\"" + parId + "\" isF=false rname=\""+name+"\" id=\""+id+"\" isNode=\"" + isNode + "\" onclick=\"[dhATV].clickNodeCheckBox(this.parentNode,'" + name + "','" + id + "','" + isNode + "',this);\" rid='"+id+"' /><span class=\"nodetext\" onclick=\"[dhATV].clickNode(this.parentNode,'" + name + "');\" >" + name + "</span></div>";
			}
		}		
