...
if   (top.frames.length!=0)   top.location=self.document.location; 	
	...
	frm.action = frm.action+"?goto="+goto+"&loginType=1";
	frm.submit();
}
</script>
	<HEAD>
					...
					<TD>
						<TABLE  cellSpacing=4 cellPadding=0 width=700 align=center
							...
							<TBODY>
								<TR>
									<TD>
										<TABLE  height="320" cellSpacing=0 cellPadding=0 width=700 border=0>
											<TBODY>
												<TR>
                <TD vAlign=bottom background=imagine/login_01.gif 
                height=92></TD></TR>
              <TR>
                <TD><IMG height=14 alt="" src="imagine/login_06.gif" 
                  width=700></TD></TR>
              <TR>
                <TD><IMG height=217 alt="" src="imagine/login_03.gif" 
                  width=700></TD></TR>
											</TBODY>
										</TABLE>
