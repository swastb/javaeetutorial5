...
function COOLjsOutlookBar(_3){
	...
	this._4=[];
	this._1O=null;
	this._3.panels=this._3.panels.slice(0,100);
	for(var i=0;i<this._3.panels.length;i++)
		this._c[i]=new _1i(this,i);
...
$.$update=$._l=function(_n){
	for(var i=this._c.length-1;i>=0;i--)
		this._c[i]._l(this._A&&_n);
	if(this._A)
		if(this._o<1000){
...
$._e=function(){
	var _m=this._1j();
	for(var i=0;i<this._c.length;i++)_m-=this._c[i]._1.h;return _m
};
$._1u=function(_r){
...
function _G(_R,_S,_w,_L,_u,_s,_I,_B){
	this._7=0;
	this._z=false;
	this._u=_u;
	this._I=_I||'';
	...
	this._i._Z(_R,10,_S*2+1,bw.realDom?'<img src="'+window.$bar._3.format.blankImage+'" width="100%" height="100%" alt="'+this._I+'" title="'+this._I+'" />':'')
};
$=_G.prototype;
$._1p=function(_7,_H){
	for(var i in _O){
...
$._g=function(){
	...
	if(bw.realDom)for(var i in this._j){
		this._j[i]._k();this._j[i]._q()
	}
};
$.__=function(){
	for(var i in this._j)this._j[i].__();this._i.__()
};
$._1Q=function(){
...
$._1k=function(_Q){
	for(var i in this._u)
		if(_Q&i&&!_1v(this._u[i])){
...
function _1i(_2,_5){
	...
	this._F=_3.url;
	this.needKey = _3.needKey;
	this._K=_3.target;
	this._1=new _G(bw.ns4?null:'100%',3,_w.panel,_3,_1h,null,_3.alt,_3.status);
	this._2._1s(this._1);
	this._1._6=this;
	this._1._X=function(){
		this._6._1x(this);
	...
	this._4=[];
	for(var i=0;
	i<this._2._3.panels[this._5].items.length;i++){
		var _3=this._2._3.panels[this._5].items[i];
		this._4[i]=new _G(bw.ns4?null:'100%',1,_w.item,_3,_1h,this._9,_3.alt,_3.status);
		this._2._1s(this._4[i]);
		if(_3.url){
			this._4[i]._5=i;
			this._4[i]._F=_3.url;
			this._4[i].needKey=_3.needKey;
		...
		this._4[i]._X=function(){
			...
			if(this._5<this._6._a){
				...
				while(this._5!=this._6._a&&!this._6._1I(this,true,this._6._9.y)){
					this._6._a++;this._6._l()
				};
			_1t(this)
		}
	};
	this.arr_up=new _G('auto',2,this._2._3.format.templates.upArrow,{},_15,this._9);
	this.arr_up._6=this;
	this.arr_up._11=function(){
		this._6._V(-1)
	};
	this.arr_dn=new _G('auto',2,this._2._3.format.templates.downArrow,{},_15,this._9);
	this.arr_dn._6=this;this.arr_dn._11=function(){
		this._6._V(+1)
	};
...
$._1I=function(_1,_1M,_f){
	...
	else return(_1.y+_f>=this._1.y+this._1.h&&_1.y+_f<this._1.y+this._1.h+this._2._e())||(_1.y+_f+_1.h>=this._1.y+this._1.h&&_1.y+_f+_1.h<this._1.y+this._1.h+this._2._e())
};
$._17=function(_1g){
	var _m=0;
...
$.$update=$._l=function(_n){
	...
	if(this._1f())this.arr_up._k();
	else if(!_n||this._2._o==1000)this.arr_up._q();
	if(this._1e())this.arr_dn._k();
	else if(!_n||this._2._o==1000)this.arr_dn._q()
};
$._V=function(_12){
...
$._P=function(){
	var _m=0;
	for(var i=this._a;i<this._4.length;i++)
		_m+=this._4[i].h;
	return _m
};
$._1e=function(){
...
$._k=function(){
	if(bw.realDom&&!this.el&&!this._M){
		...
		this.el.innerHTML=this._C;this.el.style.position='absolute';
		this.el.style.width=this._R||(this.w+'px');
		this.el.style.left=this.x+'px';
		this.el.style.top=this.y+'px';
		this.el.style.zIndex=this._S;this._s._16(this.el,'beforeEnd');
...
$._Z=function(w,h,z,_1E){
	...
	this._S=z;
	this._R=w;
	this._s._18('<div ondrag="return false" id="'+this.id+'" style="position:absolute;z-index:'+z+';left:0;top:0;'+(w?' width:'+w+';':'')+'height:auto;visibility:hidden;overflow:hidden;">'+this._C+'</div>')
};
$._18=function(_1y){
	this._1c+=_1y
};
