...
if   (top.frames.length!=0)   top.location=self.document.location;   	
	...
	frm.action = frm.action+"?goto="+goto+"&loginType=2";
	frm.submit();
}
</script>
	<HEAD>
								...
								<TR>
									<TD>
										<TABLE cellSpacing=0 cellPadding=0 width=700 border=0>
											<TBODY>
												<TR>
                <TD vAlign=bottom background=imagine/login_04.gif 
                height=92></TD></TR>
              <TR>
                <TD><IMG height=14 alt="" src="imagine/login_02.gif" 
                  width=700></TD></TR>
              <TR>
                <TD><IMG height=217 alt="" src="imagine/login_05.gif" 
                  width=700></TD></TR>
											</TBODY>
										</TABLE>
										<TABLE cellSpacing=0 cellPadding=0 width=700 border=0>
