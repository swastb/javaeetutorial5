        ...
        <tr>
          <td width="288" height="40" align="left" valign="middle" background="images/8-1.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="84%" class="table2_topic">可监控的收文</td>
            </tr>
          </table></td>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#0e88b9">
		...
		<%}%>
                   ...
                   <table width="99%" border="0" cellspacing="0" cellpadding="0" align="right">
						...
						<tr>
							<td class="tabin_page">
							<a href="<%=path%>/docRecListAction.do?method=movePageDocRec&moveTo=<%=curPage - 1%>&sessionID=<%=sessionID%>&pageName=canMonitorList&who=<%=who %>">上一页</a>
							<a href="<%=path%>/docRecListAction.do?method=movePageDocRec&moveTo=<%=curPage + 1%>&sessionID=<%=sessionID%>&pageName=canMonitorList&who=<%=who %>">下一页
							</a> 第 1 页 每页显示
							<a href="<%=path%>/docRecListAction.do?method=resetPageSizeDocRec&pageSize=10&sessionID=<%=sessionID%>&pageName=canMonitorList&who=<%=who %>">10</a>
							<a href="<%=path%>/docRecListAction.do?method=resetPageSizeDocRec&pageSize=20&sessionID=<%=sessionID%>&pageName=canMonitorList&who=<%=who %>">20</a>
							<a href="<%=path%>/docRecListAction.do?method=resetPageSizeDocRec&pageSize=30&sessionID=<%=sessionID%>&pageName=canMonitorList&who=<%=who %>">30</a> 条 共<%=count %>条
							</td>
						</tr>
					</table>
                    </td>
