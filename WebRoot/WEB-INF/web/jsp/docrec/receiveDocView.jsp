...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>上海市水务信息中心公文处理单（查看）</title>
		<meta http-equiv="pragma" content="no-cache">
		<meta http-equiv="cache-control" content="no-cache">
		<meta http-equiv="expires" content="0">
		<meta http-equiv="description" content="上海市水务信息中心公文处理单（查看）">
...
<script type="text/javascript">
function back(){
	window.location.href="<%=path%>/docRecListAction.do?method=disposedList";
}
function onlyNum(){ 
...
function changeDiv(showDiv,hideDiv){
	...
	<body onload="init()">
		<html:form action="/docRecRelateAction" method="post">
        ...
        <tr>
          <td width="288" height="40" align="left" valign="middle" background="images/8-1.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="84%" class="table2_topic">上海市水务信息中心公文处理单（查看）</td>
            </tr>
          </table></td>
          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="table2bg">
            <tr>
              <td align="center" valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0" class="table2bgin">
                <tr>
                  <th width="94%" height="30" align="right" valign="bottom"><img src="images/fh.gif" width="46" height="25" border="0" onclick="back()" onmouseover="this.style.cursor='hand'"/></th>
