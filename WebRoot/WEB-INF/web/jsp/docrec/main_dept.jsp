...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>上海市水务信息中心公文处理单（主办部门处理）</title>
		<meta http-equiv="pragma" content="no-cache">
		<meta http-equiv="cache-control" content="no-cache">
		<meta http-equiv="expires" content="0">
		<meta http-equiv="description" content="上海市水务信息中心公文处理单（主办部门处理）">
...
function init(){
//主办科室意见、附件
	var needInputs = new Array("mainDeptOpinion");
	...
	document.getElementById("mainDeptSelect").style.display="block";
}
//-->
</script>
<script type="text/javascript">
        ...
        <tr>
          <td width="288" height="40" align="left" valign="middle" background="images/8-1.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="84%" class="table2_topic">上海市水务信息中心公文处理单（主办部门处理）</td>
            </tr>
          </table></td>
