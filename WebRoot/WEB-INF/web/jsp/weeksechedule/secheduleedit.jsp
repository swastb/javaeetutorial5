													...
													<tr>
														...
														<td height="25" colspan="2">
															<html:text property="itemTitle" maxlength="100"
																style="color: 4c6a95;text-indent: 1pt;height: 18px;width: 87%;border: 1px solid #a5a5a5" onkeydown="notNull();"
													...
													<tr>
														...
														<td height="25" colspan="2">
															...
															<html:text property="startTime" style="color: 4c6a95;text-indent: 1pt;height: 18px;width: 87%;border: 1px solid #a5a5a5"
																onfocus="setday(this)" readonly="true" title="点击选择时间"></html:text>
															<%
															} else {
															%>
															<html:text property="startTime" style="color: 4c6a95;text-indent: 1pt;height: 18px;width: 87%;border: 1px solid #a5a5a5"
																value="<%=date%>" onfocus="setday(this)" readonly="true"
																...
																<tr>
																	...
																	<td width="10%">
																		...
																		<table align="center" id="tabletwo" width="98%"
																			...
																			<tr>
																				<td>
																					<a onclick="selectuser('alldelete');" title="重新选择"
																						onmouseover="this.style.cursor='hand'"> <img
													...
													<tr>
														...
														<td height="25" colspan="2">
															<html:text property="rem" style="color: 4c6a95;text-indent: 1pt;height: 18px;width: 87%;border: 1px solid #a5a5a5"
																maxlength="200" onkeydown="notNull();" onblur="chk();"></html:text>
															<font color="red">*</font>
