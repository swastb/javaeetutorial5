...
function xClick(p_url,p_name,type){
	...
	if (type=="root")
		document.form4tree.action="<%=path%>/commonalityCommAction.do?method=list&parentid="+p_url+"&p_name="+p_name+"&type="+type;
	else
		document.form4tree.action="<%=path%>/commonalityaction.do?method=list&parentid="+p_url+"&p_name="+p_name+"&type="+type;
