...
<!--
		...
		function hui(){
			...
			var type = "<%=type%>";
			if(hui=='1'){
				window.location.replace('<%=path%>/consultationSLWaitListAction.do?method=list');
			}else if(hui=='2'){
				window.location.replace('<%=path%>/consultationSLProcessListAction.do?method=list');
			}else if(hui=='3'){
				window.location.replace('<%=path%>/consultationSLOverListAction.do?method=list');
			}else if(hui=='4'){
				window.location.replace('<%=path%>/consultationWaitListAction.do?method=list&type='+type);
			}else if(hui=='5'){
				window.location.replace('<%=path%>/consultationOverListAction.do?method=list&type='+type);
			}
		}
//-->
</script>
		 ...
		 <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#0e88b9">			
          ...
          <td><table width="99%" align="center" border="0" cellpadding="0" cellspacing="0" class="table2bg">
			...
			<table align="center" width="99%" border="0" cellpadding="0" cellspacing="1"  class="tabin1_in">
				<thead class="bg-zw">
					<tr>
			    		<td nowrap  height="25" width="12%" align="center" class="bg-zwbt">咨询人</td>
					...
					<tr>
			    		<td nowrap  height="25" align="center" class="bg-zwbt">咨询人邮箱</td>
			    		<td colspan="2" align="center">
			    	...
			    	<tr>
			    		<td nowrap height="25" align="center" class="bg-zwbt">咨询人联系电话</td>
			    		<td colspan="2" align="center">
			    	...
			    	<tr>
			    		<td nowrap  height="25" align="center" class="bg-zwbt">咨询主题</td>
			    		<td colspan="2" align="center">
			    	...
			    	<tr>
			    		<td nowrap height="25"  align="center" class="bg-zwbt">咨询内容</td>
			    		<td colspan="2" align="center">     
			    	...
			    	<tr>
						...
						<td colspan="3">
							<table width="100%" >
								<tr>
				    				<td>
				    						<html:text styleClass="tab_input4" property="ZBname" size="85"  readonly="true" />
			   		...
			   		<tr>
						...
						<td colspan="3">
							<table width="100%" >
								<tr>
				    				<td>
				    					<html:text styleClass="tab_input4" property="IDEAname" size="85"  readonly="true" />
