...
<html>
	<head>
		...
		<script type='text/javascript'
			src='<%=strpath%>/dwr/interface/authlvl.js'></script>
		<script type="text/javascript" src="<%=path%>/js/common.js"></script>

	</head>

	<body>
		<html:form action="/authlvlaction.do">
        ...
        <tr>
          <td width="288" height="40" align="left" valign="middle" background="images/8-1.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="84%" class="table2_topic">权限级别</td>
            </tr>
          </table></td>
					...
					<tr>
																	...
																	<td colspan="2">
																		<html:text property="ename" maxlength="32"
																			...
																			onblur="chk(),authlvlEnameCheck();"></html:text>
																		<font color="red">*</font>
																		<font color="red"> <span id="fename"></span> <span
																			id="authlvlEnameCheck"></span> </font>
																	</td>
																</tr>
																<tr>
																	<td nowrap width="110" height="25" align="left">
																	...
																	<td colspan="2">
																		<html:text property="code" maxlength="32"
																			styleClass="shuruk2" onkeydown="notNull();"
																			onblur="chk(),authlvlCodeCheck();"></html:text>
																		<font color="red">*</font>
																		<font color="red"> <span id="fcode"></span> <span
																			id="authlvlCodeCheck"></span> </font>
																	</td>
																</tr>
																<tr>
																	<td nowrap width="110" height="25" align="left">
																	...
																	<td colspan="2">
																		...
																		<font color="red">*</font><span id="fname"></span>
																	</td>
																</tr>
																<tr>
...
<script type="text/javascript">
		   ...
		   var rem = document.getElementById("rem").value;
            ...
            if(this.authlvlEnameflag=="false"){alert("不能重复"); return false;}
            
            authlvlCodeCheck();
            if(this.authlvlCodeflag=="false"){alert("不能重复"); return false;}
			...
			if(document.all.id.value==''){document.all.method.value='add'}
				...
				window.location.replace(pah+"/authlvlaction.do?method=list");
