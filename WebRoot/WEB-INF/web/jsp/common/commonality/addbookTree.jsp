...
<html>
	...
	<form id="list" name="list" method="post">
				...
				<script language="javascript" type="text/javascript">
					...
					//设置请求地址
					dhATV.postUrl = "<%=path%>/commonalityTree.do?method=showTree&type=${param.type==null?"":param.type}&parentId=";
					//设置节点事件
					...
					var rootNode = document.getElementById("tree").childNodes[0];
					dhATV.showNode(rootNode);
					showNextNodes(rootNode,dhATV);
				</script>
				<NOSCRIPT>
