...
<html>
  <head>
    ...
    <title>My JSP 'zfxxgksqdas3.jsp' starting page</title>
	...
	<script type="text/javascript">
		...
		function printTest(){
			var param1 = "<%=basePath%>zfxxgksqdfs3action.do?method=add&id=6&rem="
			var param2 = "print"
			window.location="<%=basePath%>docEditTest.do?method=add&param1="+param1+"&param2="+param2;
		}
		function print(){
			...
			if(flag || <%=request.getAttribute("editYesOrNo")%>=='0'){
				...
				var url = "<%=basePath%>zfxxgksqdfs3action.do?method=add&rem="+rem;
...
<html:form action="/zfxxgksqdfs3action.do?method=addOrEditSave">
<div align="center" id="allBody">
<table width="620" border="0" align="center">
  <tr>
    <td align="center"><span class="titleTop" style="font-size:18.0pt;font-family:SimSun;">政府信息公开申请答复书（三）</span></td>
  </tr>
  <tr>
    <td align="right" class="content" width="100%" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;">沪水务非信答(<%=lsNo.substring(0,4) %>)第<input type="text" name="year1" value="<%=lsNo.substring(4,lsNo.length()) %>" class="UNDERLINE35"/><span ></span>号</td>
  </tr>
  <tr>
    <td align="left" class="content" width="100%" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;"><html:text property="applicant" readonly="true" styleClass="UNDERLINE150"/><span ></span>：</td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="100%" class="content" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;"><html:text property="attr1" readonly="true" styleClass="UNDERLINE320"/><span ></span>的申请。</td>
  </tr>
  <tr>
    <td width="100%" class="content" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;">&nbsp;&nbsp;&nbsp;&nbsp;经审查，您（单位）要求获取的信息不属于《中华人民共和国政</td>
  </tr>
  <tr>
    <td width="100%" class="content" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;">府信息公开条例》和《上海市政府信息公开规定》第二条所指的政府</td>
  </tr>
  <tr>
    <td width="100%" class="content" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;">信息。现依据《上海市政府信息公开规定》第二十三条第（三）项的</td>
  </tr>
  <tr>
    <td width="100%" class="content" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;">规定予以答复。</td>
  </tr>
  <tr>
    <td width="100%" class="content" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;">&nbsp;&nbsp;&nbsp;&nbsp;如对本答复不服，可以在收到本答复之日起60日内向上海市人民</td>
  </tr>
  <tr>
    <td width="100%" class="content" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;">政府 或者中华人民共和国水利部申请行政复议，或者在3个月内向人</td>
  </tr>
  <tr>
    <td width="100%" class="content" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;">民法院提起行政诉讼。</td>
  </tr>
  <tr>
    <td width="100%" class="content" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;">&nbsp;&nbsp;&nbsp;&nbsp;特此告知。</td>
  </tr>
  <tr>
    <td align="right" width="100%" class="content" style="font-size:15.0pt;mso-char-indent-count:2.0;mso-bidi-font-size:12.0pt;"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="100%" class="BeiZhuCon">&nbsp;&nbsp;&nbsp;&nbsp;本文本适用于《上海市政府信息公开规定》第二十三条第（三）项关于对“不属于政府信息范围”的答复。</td>
  </tr>
