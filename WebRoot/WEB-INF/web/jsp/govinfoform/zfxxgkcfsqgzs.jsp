...
<html>
  <head>
    ...
    <title>My JSP 'zfxxgkcfsqgzs.jsp' starting page</title>
	...
	<script type="text/javascript">
		...
		function print(){
			...
			if(flag || <%=request.getAttribute("editYesOrNo")%>=='0'){
				...
				var url = "<%=basePath%>zfxxgkcfsqgzsaction.do?method=add";
...
<html:form action="/zfxxgkcfsqgzsaction.do?method=addOrEditSave" >
<div align="center">
<table width="70%" border="0">
  <tr>
    <td align="center"><span class="titleTop">政府信息公开重复申请告知书</span></td>
  </tr>
  <tr>
    <td class="content" width="100%" align="right">沪水务重信告(<%=lsNo.substring(0,4) %>)第<input type="text" name="year1" value="<%=lsNo.substring(4,lsNo.length()) %>" class="UNDERLINE35"/>号</td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="content" width="100%">&nbsp;&nbsp;&nbsp;&nbsp;经审查，您（单位）提出的申请为重复申请，根据《上海市政府</td>
  </tr>
  <tr>
    <td class="content" width="100%">信息公开规定》第二十三条第（九）项的规定，本机关（机构）不再</td>
  </tr>
  <tr>
    <td class="content" width="100%">重复处理。</td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="100%" class="BeiZhuCon">&nbsp;&nbsp;&nbsp;&nbsp;本文本适用于《上海市政府信息公开规定》第二十三条第（九）项关于“政府信息公开重复申请”情形的答复。</td>
  </tr>
