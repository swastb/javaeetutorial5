...
<!--
		...
		function hui(){
			...
			var type = "<%=type%>";
			if(hui=='1'){
				window.location.replace('<%=path%>/appealSLWaitListAction.do?method=list');
			}else if(hui=='2'){
				window.location.replace('<%=path%>/appealSLProcessListAction.do?method=list');
			}else if(hui=='3'){
				window.location.replace('<%=path%>/appealSLOverListAction.do?method=list');
			}else if(hui=='4'){
				window.location.replace('<%=path%>/appealWaitListAction.do?method=list&type='+type);
			}else if(hui=='5'){
				window.location.replace('<%=path%>/appealOverListAction.do?method=list&type='+type);
			}
		}
//-->
</script>
...
<html>
	...
	<body onload="init();">
		<html:form action="/appealView.do" method="post">
          ...
          <td><table width="99%" align="center" border="0" cellpadding="0" cellspacing="0" class="table2bg">
			...
			<table align="center" width="99%" border="0" cellpadding="0" cellspacing="1"  class="tabin1_in">
				<thead class="bg-zw">
					...
					<tr>
			    		<td nowrap  height="25" align="center" class="bg-zwbt">投诉人邮箱</td>
			    		<td colspan="2" align="center">
			    	...
			    	<tr>
			    		<td nowrap height="25" align="center" class="bg-zwbt">投诉人联系电话</td>
			    		<td colspan="2" align="center">
			    	...
			    	<tr>
			    		<td nowrap  height="25" align="center" class="bg-zwbt" >投诉主题</td>
			    		<td colspan="2" align="center">
			    			<html:text style="vertical-align:middle"  property="Subject" maxlength="50"  style="width:98%" styleClass="input-noborder" readonly="true" ></html:text>
			    		</td>
			    	</tr>
			    	
			    	<tr>
			    		<td nowrap height="25"  align="center" class="bg-zwbt">投诉内容</td>
			    		<td colspan="2" align="center">
