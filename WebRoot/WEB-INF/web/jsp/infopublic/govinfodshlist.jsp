														...
														<td align="center" valign="bottom">
															<table width="99%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td width="18%" height="25" class="tabin_atabno">
																		<span onclick="javascript:infodshList();"
																			onmouseover="this.style.cursor='hand'">信息发布</span>
																	</td>
															...
															<table width="99%" border="0" cellpadding="0"
																...
																<%
																		...
																		TbGovInfoPubContent item = (TbGovInfoPubContent) infoConList.get(i);
																%>
																<tr align="center" class="bg-zw">
																	...
																	<td align="center" width="10%">
																		<a
																			href="<%=path%>/govinfopubContentaction.do?method=bsdshview&type=<%=type %>&p_name=<%=item.getAttr2()%>&parentid=<%=parentid%>&id=<%=item.getFileId()%>"><%=str%>
																		</a>	
																	</td>
																	<td align="center" width="10%">
																		<a
																			href="<%=path%>/govinfopubContentaction.do?method=delete&p_name=<%=item.getAttr2()%>&parentid=<%=item.getInfoSubject()%>&id=<%=item.getFileId()%>"
															...
															<table width="99%" border="0" cellspacing="0"
																...
																<tr>
																	<td class="tabin_page">
																		<a
																			href="<%=path%>/govinfopubContentaction.do?method=movePageInfo&moveTo=<%=curPage - 1%>&sessionID=<%=sessionID%>&parentid=<%=parentid%>&p_name=<%=p_name%>&pageName=govdshlist&type=<%=type %>"><span
																		...
																		<a
																			href="<%=path%>/govinfopubContentaction.do?method=resetPageSizeInfo&pageSize=10&sessionID=<%=sessionID%>&parentid=<%=parentid%>&p_name=<%=p_name%>&pageName=govdshlist&type=<%=type %>"><span
																			class="bg-zw">10</span> </a>
																		<a
																			href="<%=path%>/govinfopubContentaction.do?method=resetPageSizeInfo&pageSize=20&sessionID=<%=sessionID%>&parentid=<%=parentid%>&p_name=<%=p_name%>&pageName=govdshlist&type=<%=type %>"><span
																			class="bg-zw">20</span> </a>
																		<a
																			href="<%=path%>/govinfopubContentaction.do?method=resetPageSizeInfo&pageSize=30&sessionID=<%=sessionID%>&parentid=<%=parentid%>&p_name=<%=p_name%>&pageName=govdshlist&type=<%=type %>"><span
...
function selectByName()
{
    ...
    window.location.href="<%=path%>/govinfopubContentaction.do?method=list&type=dsh&infoname="+infoname+"&parentid=<%=parentid%>&p_name=<%=p_name%>";
}
</script>