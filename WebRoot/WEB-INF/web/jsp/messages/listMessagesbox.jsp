              ...
              <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="table2bgin">
                ...
                <tr>
                  ...
                  <tr>
                   ...
                   <td width="16%" class="tabin_atabno"><a href="<%=path %>/messages.do?method=findMessages">收件箱</a></td>
                   <td width="16%" class="tabin_atab">发件箱</td>
                   <td class="bg-zw" align="right"><input name="Submit2" type="button" class="button0" value="发信息" onclick="location.href='<%=path%>/messages.do?method=sendMessages&action=add';"
12．		    		 	                                                      	 onmouseover="this.style.cursor='hand'"/>&nbsp;&nbsp;</td>
                  </tr>
                </table> 
			<table width="99%" border="0" cellpadding="0" cellspacing="1" class="tabin_in">	
		   <tr>
			<th width="5%" height="24" align="center" class="bg-zwbt">序号</th>
			<th height="24" width="10%" align="center" class="bg-zwbt">类别</th>
			<th height="24" width="40%" align="center" class="bg-zwbt">主题</th>
			<th height="24" width="20%" align="center" class="bg-zwbt">收件人</th>
			<th height="24" width="20%" align="center" class="bg-zwbt">发件时间</th>
			<th  align="center" colspan="3" class="bg-zwbt">操作</th>
		  </tr>
		...
		<td width="5%" align="center" height="24" class="bg-zwbt">${loop.index+1}</td>
			...
			<td width="5%" align="center" class="bg-zwbt"> 
				<a href="<%=path %>/sendMessages.do?method=lookupMessages&id=${list.id }"><span class="bg-zw"><img src="<%=path%>/images/icon10.gif" width="15" height="15" border="0" alt="查看"></span></a></td>	
    		<td width="5%" align="center" class="bg-zwbt"> 
				<a href="<%=path %>/sendMessages.do?method=deleteSend&id=${list.id }" onclick="return confirm('是否确认删除')"><span class="bg-zw"><img src="<%=path%>/imagine/sc.gif" width="15" height="15" border="0" alt="删除"></span></a></td>
		</tr>
		</c:if>
		</c:forEach>
		</table>
      	<table width="99%" border="0" cellspacing="0" cellpadding="0">
			...
			<a href="<%=path%>/sendMessages.do?method=movePage&moveTo=<%=curPage-1%>&sessionID=<%=sessionID %>"><span class="bg-zw">上一页</span></a>
		 	<a href="<%=path%>/sendMessages.do?method=movePage&moveTo=<%=curPage+1%>&sessionID=<%=sessionID %>"><span class="bg-zw">下一页</span></a>
