...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>发文稿纸（文印室填写）</title>
		<meta http-equiv="pragma" content="no-cache">
		<meta http-equiv="cache-control" content="no-cache">
		<meta http-equiv="expires" content="0">
		<meta http-equiv="description" content="发文稿纸（文印室填写）">
...
function init(){
//文号、打印人、校对人、附件
	var needInputs = new Array("fileNo","printUser","collateUser","fileCategory");
	...
	var curUserName = "${SYSTEM_USER_SESSION.name}";
	document.getElementById("printUser").value=curUserName;
	document.getElementById("collateUser").value=curUserName;
	document.getElementById("fileDate").onfocus="";
	document.getElementById("fileCategory").style.display="";
	document.getElementById("fileCategoryName").style.display="none";
	checkFileType();
	alertError();
}
//-->
...
function checkForm(form){
	...
	if(form.printUser.value==""){
		alert("请输入打印人");
		rs = false;
	}
	if(form.collateUser.value==""){
		alert("请输入校对人");
		rs = false;
	}
...
function changeDiv(showDiv,hideDiv){
	...
	<body onload="init()">
		<html:form action="/xdocSendPrinter" enctype="multipart/form-data" method="post">
        ...
        <tr>
          <td width="288" height="40" align="left" valign="middle" background="images/8-1.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="84%" class="table2_topic">发文稿纸（文印室填写）</td>
            </tr>
          </table></td>
				...
				<tr>
                  <td height="10"></td>
					...
					<tr>
						...
						<input type="button" onclick="window.print();" class="button0" value="打印">
						</td>
					</tr>
				</thead>
			</table>
