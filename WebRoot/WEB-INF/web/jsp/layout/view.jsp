...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	TbInfoPubContent item=(TbInfoPubContent)request.getAttribute("item");
...
<%} %>
	...
	<html:form action="/layoutContent.do">
      ...
      <tr>
        <td valign="top" bgcolor="#f1f8fc"><table width="100%" border="0" cellspacing="1" cellpadding="0">
           ...
           <table width="82%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="50" align="right" class="zw-time"><%=item.getRecordTime()==null?"":item.getRecordTime().toString().substring(0,10) %> </td>
              </tr>
            </table>
