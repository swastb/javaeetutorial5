...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	TbGovInfoPubContent item=(TbGovInfoPubContent)request.getAttribute("item");
...
<html>
	<head>
		...
		<link href="<%=path%>/css/index-css.css;<%=path%>/css/style1.css" rel="stylesheet" type="text/css">

	</head>
	<%  String laId=request.getParameter("claId");
      ...
      <tr>
        <td valign="top" bgcolor="#f1f8fc"><table width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td height="50" align="center" valign="bottom" background="imagine/tab_bg1.gif"><table width="94%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="90%" background="imagine/tab_bg_a.gif" class="tabp_tit"><%=item.getTitle() %></td>
           ...
           <table width="82%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="15" align="left"><p>&nbsp;&nbsp;&nbsp;&nbsp;<%=content%></p></td>
                  
              </tr>
              <tr>
                <td height="50" align="right" class="zw-time"><%=item.getCreateTime()==null?"":item.getCreateTime().toString().substring(0,10) %> </td>
              </tr>
            </table>
			...
			<table width="90%" align="center" border="0" cellspacing="0" cellpadding="0">
				...
				<input class="bg-zw" name="Submit" type="button" onClick="window.close()" value="¹Ø±Õ´°¿Ú"/>
				<%}else{ %>
				<a href="<%=path%>/layoutContent.do?method=more&claId=<%=laId%>&state=1" target="rightFrame" class="topmenu">¡¾·µ»Ø¡¿</a>
				<%} %>
